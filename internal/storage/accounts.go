...
func (s *SQLStorage) CreateAccount(acc *types.Account) error {
...
func (s *SQLStorage) DeleteAccount(id int) error {
...
func (s *SQLStorage) AllAccounts() ([]*types.Account, error) {
...
func (s *SQLStorage) AccountByID(id int) (*types.Account, error) {
...
func (s *SQLStorage) UpdateAccount(acc *types.Account) error {
...
func (s *SQLStorage) PatchAccount(id int, updates map[string]interface{}) error {
