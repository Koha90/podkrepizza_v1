...
-- Pizza
  ...
  ('Греческая', 'Томат, Перец Болгарский, Огурцы Маринованные, Сыр фетака, Маслины, Лук красный, Томатный соус, Сыр моцарелла.', './img/pizza/greek.jpg', 1, 660.00),
  ...
  ('Ветчина и грибы', 'Ветчина, Томат, Шампиньоны, Чесночный соус, Сыр моцарелла.', './img/pizza/ham_and_mushrooms.jpg', 1, 670.00),
  ('Лас Венас', 'Куриное филе, Копченая курица, Пепперони, бекон, Шампиньоны, Огурцы Маринованные, Томат, Чесночный соус, Сыр моцарелла.', './img/pizza/las_vegas.jpg', 1, 820.00),
  ('Цезарь', 'Куриное филе, Лист салата, Томат, Томаты черри, Цезарь соус, Сыр моцарелла, Сыр пармезан.', './img/pizza/caesar.jpg', 1, 840.00),
  ...
  ('Ассорти', '1/2 Лас-Вегас, 1/2 Ветчина грибы, 1/2 Пицца-Шаверма, 1/2 Американо.', './img/pizza/assorti.jpg', 1, 1020.00),
  ('Барбекю', 'Копченая курица, Баварские колбаски, Томат, Шампиньоны, Лук красный, Барбекю соус, Сыр моцарелла.', './img/pizza/barbecue.jpg', 1, 860.00),
  ('Том-Ям', 'Креветки, Кальмар, Куриное филе, Шампиньоны, Томаты черри, Соус том-ям, Сыр моцарелла.', './img/pizza/tom_yam.jpg', 1, 1050.00),
  ...
  ('Итальяно', 'Пиперине, Ветчина, Чесночный соус, Сыр моцарелла, Сыр пармезан, Орегано.', './img/pizza/italiano.jpg', 1, 790.00),
  ...
  ('Карбонара', 'Окорок, Бекон, Томат, Яйцо, Чесночный соус, Сыр моцарелла, Сыр пармезан.', './img/pizza/carbonara.jpg', 1, 760.00),
  ('Филадельфия', 'Лосось, Снежный краб, Сливочный сыр, Сыр моцарелла.', './img/pizza/philadelphia.jpg', 1, 1000.00),
-- Rolls
  ...
  ('Канада', 'Лосось, Угорь, Сливочный сыр, Авокадо.', './img/rolls/canada.jpg', 2, 550.00),
  ...
  ('Запеченный лосось с крабом', 'Лосось жареный, Снежный краб, Сырный соус, лук кранч.', './img/rolls/baked_salmon_crab.jpg', 2, 500.00),
  ('Токио', 'Лосось, Сливочный сыр, Огурец, Салат, Икра, Соус спайси, Соус унаги.', './img/rolls/tokyo.jpg', 2, 490.00),
  ('Малибу', 'Лосось, Омлет, Сливочный сыр, Огурец, Кунжут, Соуса, Икра тобика.', './img/rolls/malibu.jpg', 2, 480.00),
  ('Креветка темпура', 'Креветка, Сливочный сыр, Снежный краб.', './img/rolls/tempura_shrimp.jpg', 2, 460.00),
  ('Угорь темпура', 'Угорь, Сливочный сыр, Авокадо.', './img/rolls/tempura_eel.jpg', 2, 550.00),
