...
-- Pizza
  ...
  ('Лас Вегас', 'Куриное филе, Копченая курица, Пепперони, бекон, Шампиньоны, Огурцы Маринованные, Томат, Чесночный соус, Сыр моцарелла.', './img/pizza/las_vegas.jpg', 1, 820.00),
...
-- Shaurma
  ('Шаурма классик', 'Курица с гриля, Огурцы свежие, Томат, Морковь по-корейски, Соус шаверма, Кетчуп.', './img/shaurma/shaurma_classic.jpg', 3, 260.00),
  ('Барбекю шаурма', 'Курица копченая, Курица с гриля, Бекон, Картофель фри, Томат, Огурцы Маринованные, Соус шаверма, Соус барбекю.', './img/shaurma/bbq_shaurma.jpg', 3, 350.00),
  ...
  ('Гавайская шаурма', 'Курица копченая, Курица с гриля, Ананас, Томат, Морковь по-корейски, Сыр Моцарелла, Соус шаверма.', './img/shaurma/hawaiian_shaurma.jpg', 3, 310.00),
  ('Том-ям шаурма', 'Креветки, Курица с гриля, Шампиньоны, Салат, Томат, Лук, Соус том-ям.', './img/shaurma/tom_yam_shaurma.jpg', 3, 380.00),
-- Shaverma
  ('Шаверма', 'Курица с гриля, Огурцы свежие, Томат, Морковь по-корейски, Соус шаверма, Кетчуп.', './img/shaverma/shaverma.jpg', 4, 380.00),
-- Sets
